    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.leadscout.app https://*.clerk.accounts.dev https://*.clerk.com https://*.ondigitalocean.app https://js.stripe.com https://*.convex.cloud https://*.convex.site https://challenges.cloudflare.com",
